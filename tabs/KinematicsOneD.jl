        ...
        children = [
            ...
            html_tr(
                children = [
                    html_th("x₀ : "),
                    html_td(dcc_input(
                        id = "input-k1d-start-pos",
                        value = nothing,
                        type = "number",
                        placeholder = "Initial Position",
                    ),),
                    html_td(dcc_dropdown(
                        id = "input-k1d-start-pos-unit",
                        options = [
            ...
            html_tr(
                children = [
                    html_th("x : "),
                    html_td(dcc_input(
                        id = "input-k1d-final-pos",
                        value = nothing,
                        type = "number",
                        placeholder = "Final Position",
                    ),),
                    html_td(dcc_dropdown(
                        id = "input-k1d-final-pos-unit",
                        options = [
                            (label = i, value = i) for i in Units.length_units
                        ],
                        value = "meter (m)",
            ...
            html_tr(
                children = [
                    ...
                    html_td(dcc_dropdown(
                        id = "input-k1d-velocity-init-unit-d",
                        options = [
                            (label = i, value = i) for i in Units.length_units
                        ],
                        value = "meter (m)",
                    ...
                    html_td(dcc_dropdown(
                        id = "input-k1d-velocity-init-unit-t",
                        options = [
            ...
            html_tr(
                children = [
                    html_th("v̄ : "),
                    html_td(dcc_input(
                        id = "input-k1d-average-vel",
                        value = nothing,
                        type = "number",
                        placeholder = "Average Velocity",
                    ),),
                    html_td(dcc_dropdown(
                        id = "input-k1d-average-vel-unit-d",
                        options = [
                            (label = i, value = i) for i in Units.length_units
                        ],
                        value = "meter (m)",
                    ...
                    html_td(dcc_dropdown(
                        id = "input-k1d-average-vel-unit-t",
                        options = [
                            (label = i, value = i) for i in Units.time_units
                        ],
                        value = "seconds (s)",
            ...
            html_tr(
                children = [
                    ...
                    html_td(dcc_dropdown(
                        id = "input-k1d-velocity-final-unit-d",
                        options = [
                            (label = i, value = i) for i in Units.length_units
                        ],
                        value = "meter (m)",
                    ...
                    html_td(dcc_dropdown(
                        id = "input-k1d-velocity-final-unit-t",
                        options = [
                            (label = i, value = i) for i in Units.time_units
                        ],
                        value = "seconds (s)",
            ...
            html_tr(
                children = [
                    ...
                    html_td(dcc_dropdown(
                        id = "input-k1d-acceleration-unit-d",
                        options = [
                            (label = i, value = i) for i in Units.length_units
                        ],
                        value = "meter (m)",
                    ...
                    html_td(dcc_dropdown(
                        id = "input-k1d-acceleration-unit-t",
                        options = [
                            (label = i, value = i)
